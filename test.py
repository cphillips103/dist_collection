...
class TestBinomialClass(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.binomial.data_count, 20, 'n value incorrect')
    ...
    def test_add(self):
        ...
        self.assertEqual(binomial_sum.probability, .4)
        self.assertEqual(binomial_sum.data_count, 80)
        
class TestPoissonClass(unittest.TestCase):
    def setUp(self):
        self.poisson = Poisson(3, 4.6)

    def test_calculatePDf(self):
        prob = self.poisson.pdf()
        self.assertEqual(round(prob,6), 0.163068)
